...
SearchEngine::dispatch( FILE * fout, const char * documentRequested)
{
   ...
   if (strcmp(documentRequested, "/")==0) {
    ...
    fprintf(fout, "<CENTER><font color=\"white\" font size=\"200\" font face=\"Helvetica\">Boiler Search</font><CENTER>\n");
    fprintf(fout, "<H2>\n");
...
//printf("cat_string %s\n", cat_string);
  ...
  fprintf(fout, "<BODY alink=\"#4789ED\" background=\"http://cdn.superbwallpapers.com/wallpapers/abstract/dar-pastel-blur-29203-1920x1080.jpg\">\n");
